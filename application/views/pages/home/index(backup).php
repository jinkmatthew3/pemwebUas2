          ...
          <div class="col-lg-4" style="margin-bottom: 10px;">
              <div class="product card">
                ...
                <div class="card-body">
                  ...
                  <img src="<?= base_url(); ?>/assets/uploads/gender/cowo.jpg" alt="" class="img-fluid" style="width: 300px;"></a>
                  </center>
                </div>
              </div>
            <!-- /.product            -->
          ...
          <div class="col-lg-4" style="margin-bottom:10px">
              <div class="product card"  style="background-color: white;">
                ...
                <div class="card-body">
                  ...
                  <img src="<?= base_url(); ?>assets/uploads/gender/semua.jpg" alt="" class="img-fluid" style="width: 300px;"></a>
                  </center>
                </div>
              </div>
            <!-- /.product            -->
           ...
           <div class="col-lg-4" style="margin-bottom:10px">
              <div class="product card ">
                ...
                <div class="card-body">
                  ...
                  <img src="<?= base_url(); ?>assets/uploads/gender/cewe.jpg" alt="" class="img-fluid" style="width: 300px;"></a>
                  </center>
                </div>
              </div>
            <!-- /.product            -->
