    ...
    <div class="container" style="padding: 15px 0 15px 0">
      <div class="row justify-content-center">
        ...
        <?php foreach ($produk as $barang) : ?>
          <h1 style="text-align: center;"><strong>PRODUCT DETAIL</strong></h1>
          <hr style="border-color  : #71BEA3;">
          <div class="row">
            <div class="col-lg-7 col-md-7 product_image">
              <img src="<?php echo base_url(); ?>assets/uploads/poto/<?= $barang['Image'] ?>" width="60%" class="img-fluid" style="margin:100px 100px 100px 100px">
            </div>
            <div class="col-lg-5 col-md-5">
                <div class="product_name">
                  <h1 class="text-center"><?= $barang['name'] ?></h1>
                </div>
                <h4 style="padding-top:30px">Product details</h4>
